 ...
 * Custom stops configured for user (Улица Станковая (Саша), Улица Канадская в обе стороны (АТБ), Переулок Закарпатский (Ярик)).
 */
public class TransportService {
    ...
    public static final List<StopInfo> STOPS = Arrays.asList(
            ...
            new StopInfo("3", "Переулок Закарпатский (Ярик)", 7, "к 759-му мкрн"),
